    ...
    <TouchableOpacity style={styles.farmCard} onPress={onPress}>
      ...
      <View style={styles.farmInfo}>
        ...
        <View style={styles.farmLocation}>
          ...
          <Text style={styles.farmLocationText}>{farm.location || "No location set"}</Text>
        </View>
...
export default function Farms() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Add Farm Button */}
        <TouchableOpacity style={styles.addButton} onPress={() => router.push("/farms/add")}>
        ...
        {farms.length === 0 ? (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySubText}>Add your first farm to get started</Text>
          </View>
        ) : (
          farms.map((farm) => (
            <FarmCard key={farm.id} farm={farm} onPress={() => router.push(`/farms/${farm.id}`)} />
          ))
        )}
        ...
        <View style={styles.summarySection}>
          ...
          <View style={[styles.summaryCard, { backgroundColor: Colors.green100 }]}>
...
const styles = StyleSheet.create({
  ...
  farmLocation: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 4, marginBottom: 12 },
  ...
  viewAnimalsBtnText: { color: Colors.primary, fontWeight: "700", fontSize: 14 },
  ...
  menuHeader: { padding: 12, borderBottomWidth: 1, borderBottomColor: Colors.border },
